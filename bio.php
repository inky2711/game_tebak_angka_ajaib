<?php 
    ...
    $orang = mysqli_query($kon, "SELECT * FROM user WHERE id_user = '$id'");
    $user = mysqli_fetch_assoc($orang);

    $posting = mysqli_query($kon, "SELECT * FROM posting WHERE id_user = '$id' ORDER BY id_postingan DESC");
 ?>
		    	...
		    	<div class="row no-gutters d-flex">
	    			<div class="col-md-12 col-lg-6 d-flex align-items-stretch">
	    				<div class="img-about img d-flex align-items-stretch">
		    				<div class="img d-flex align-self-stretch align-items-center" style="background-image:url(<?= $user['image'] ?>);">
		    				</div>
	    				</div>
	    			</div>
	    			<div class="col-md-12 col-lg-6 pl-lg-5 py-5 d-flex align-items-center">
	    				<div class="p-0 px-lg-5 p-lg-0">
				          ...
				          <div class="col-md-12 heading-section ftco-animate">
				          	<span class="subheading">HI My Name Is</span>
				            <h2 class="mb-4"><?= $user['nama'] ?></h2>
				            <p><?= $user['status'] ?></a></p>
				          </div>
				        </div>
		              ...
		              <div class="text">
		              	<p class="mb-0">
			                <span class="number" data-number="<?= $user['number'] ?>">0</span>
			                <span>My Lucky Number</span>
		                </p>
	        ...
	        <div class="row d-flex justify-content-center">
	          <div class="col-md-10 text-center d-flex ftco-animate">
	          	<div class="blog-entry justify-content-end">
	          	  <img class="aku" src="<?= $key['image'] ?>"></img><h1 class="kamu"><a ><?= $key['nama'] ?></a></h1>
	   ...
	   <!--  <section class="ftco-section">
	    	...
	    	<h1>KELUHAN</h1>
	    		<form action="" method="post">
	    			<table>
	    				<tr>
	    					<td><label for="isi">Keluhan</label></td>
	    					<td>:</td>
